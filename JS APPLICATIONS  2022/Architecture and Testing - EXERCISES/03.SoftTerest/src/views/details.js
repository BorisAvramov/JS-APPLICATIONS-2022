...
import {deleteIdeaById, getIdeaDetailsById} from '../api/data.js';
...
async function loadIdeaDetails(id){
     const ideaDetails = await getIdeaDetailsById (id);

     section.replaceChildren(createIdeaDiv(ideaDetails));
